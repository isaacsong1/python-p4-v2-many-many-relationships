...
class Employee(db.Model):
    ...
    projects = association_proxy('assignments', 'project', creator=lambda project_obj:
...
class Project(db.Model):
    ...
    employees = association_proxy('assignments', 'employee', creator=lambda employee_obj:
                                Assignment(employee=employee_obj))
